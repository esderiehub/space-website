...
function pickStarColor() {
    const colors = [
        '255,255,255', '200,210,255',
        '255,220,180', '180,220,255', '255,180,200'
    ];
...
const planetData = {
    mercury: {
        ...
        gradient: 'linear-gradient(135deg, #b5b5b5, #555)', emoji: '🪨',
        diameter: '4,879 km', orbit: '88 Earth Days', moons: '0',
        temp: '-180°C to 430°C', distance: '77.3 million km from Earth',
        ...
        facts: [
            'Fastest planet — orbits Sun in 88 days',
            'Surface temperatures swing 600°C',
            'Has no moons or rings',
            'Visited by Mariner 10 and MESSENGER',
            'Its core makes up 85% of its radius'
        ],
    },
    venus: {
        name: 'Venus', color: '#c9a227',
        gradient: 'linear-gradient(135deg, #e8c97d, #8a6a10)', emoji: '🌋',
        diameter: '12,104 km', orbit: '225 Earth Days', moons: '0',
        temp: '465°C (average)', distance: '40.4 million km from Earth',
        ...
        facts: [
            'Hottest planet — 465°C surface temp',
            'Rotates backwards (east to west)',
            'A day on Venus is longer than its year',
            'Covered in thousands of volcanoes',
            'Atmospheric pressure crushes metal'
        ],
    },
    earth: {
        name: 'Earth', color: '#4a9eff',
        gradient: 'linear-gradient(135deg, #4a9eff, #0d4a8f)', emoji: '🌍',
        diameter: '12,742 km', orbit: '365.25 Days', moons: '1 (The Moon)',
        temp: '-88°C to 58°C', distance: '0 km (Home)',
        ...
        facts: [
            ...
            'Has a powerful protective magnetic field',
            'Tilted 23.5° — creating our seasons',
            'Moving 30 km/s around the Sun right now'
        ],
    },
    mars: {
        name: 'Mars', color: '#e07050',
        gradient: 'linear-gradient(135deg, #e07050, #8a2510)', emoji: '🔴',
        diameter: '6,779 km', orbit: '687 Earth Days', moons: '2 (Phobos & Deimos)',
        temp: '-125°C to 20°C', distance: '78.3 million km from Earth',
        ...
        facts: [
            ...
            'Has the longest canyon in the Solar System',
            'Perseverance rover is active there now',
            'A Martian day is 24h 37m — similar to Earth',
            'SpaceX plans to colonize Mars'
        ],
    },
    jupiter: {
        name: 'Jupiter', color: '#c8903a',
        gradient: 'linear-gradient(135deg, #c8903a, #6b4010)', emoji: '🌪️',
        diameter: '139,820 km', orbit: '12 Earth Years', moons: '95 confirmed',
        temp: '-110°C (cloud tops)', distance: '628.7 million km from Earth',
        ...
        facts: [
            '11× wider and 318× more massive than Earth',
            'Great Red Spot storm is 350+ years old',
            'Europa may have a subsurface ocean with life',
            'Has a faint ring system',
            'Acts as a cosmic vacuum cleaner protecting Earth'
        ],
    },
    saturn: {
        name: 'Saturn', color: '#c8b840',
        gradient: 'linear-gradient(135deg, #e8d870, #8a7810)', emoji: '💍',
        diameter: '116,460 km', orbit: '29 Earth Years', moons: '146 confirmed',
        temp: '-140°C (average)', distance: '1.2 billion km from Earth',
        ...
        facts: [
            'Ring system spans 282,000 km but is only 1km thick',
            'Least dense planet — would float on water',
            'Titan is the only moon with a thick atmosphere',
            'Winds reach 1,800 km/h',
            '146 known moons — the most in the Solar System'
        ],
    },
    uranus: {
        name: 'Uranus', color: '#40b8c8',
        gradient: 'linear-gradient(135deg, #40b8c8, #104858)', emoji: '🔵',
        diameter: '50,724 km', orbit: '84 Earth Years', moons: '27 confirmed',
        temp: '-224°C (coldest planet)', distance: '2.7 billion km from Earth',
    ...
    neptune: {
        name: 'Neptune', color: '#3060b8',
        gradient: 'linear-gradient(135deg, #4080e8, #102060)', emoji: '💨',
        diameter: '49,244 km', orbit: '165 Earth Years', moons: '16 confirmed',
        temp: '-214°C (average)', distance: '4.4 billion km from Earth',
        ...
        Its largest moon, Triton, orbits backwards and is slowly spiraling inward,
        destined to be torn apart in ~3.6 billion years.`,
        facts: [
            'Strongest winds: 2,100 km/h',
            'Takes 165 years to orbit the Sun',
            'Discovered by math before it was seen',
            'Triton orbits backwards (retrograde)',
            'Only visited by Voyager 2 in 1989'
        ],
    },
};
...
function openModal(planet) {
    ...
    pmBody.innerHTML = `
        ...
        <div class="pm-details">
            <div class="pm-grid">
                <div class="pm-stat">
                    <span class="pm-stat-label">Diameter</span>
                    <span class="pm-stat-value">${d.diameter}</span>
                </div>
                <div class="pm-stat">
                    <span class="pm-stat-label">Orbital Period</span>
                    <span class="pm-stat-value">${d.orbit}</span>
                </div>
                <div class="pm-stat">
                    <span class="pm-stat-label">Moons</span>
                    <span class="pm-stat-value">${d.moons}</span>
                </div>
                <div class="pm-stat">
                    <span class="pm-stat-label">Temperature</span>
                    <span class="pm-stat-value">${d.temp}</span>
                </div>
            </div>
...
window.addEventListener('scroll', () => {
    ...
    const prog      = scrolled / maxScroll;

    scrollTopBtn.classList.toggle('visible', scrolled > 400);

    if (stCircle) {
        stCircle.style.strokeDashoffset = 138 - (138 * prog);
    }
});
